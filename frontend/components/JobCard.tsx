...
export default function JobCard({ job }: JobCardProps) {
  return (
    <div className="w-full h-full my-3 bg-white rounded-2xl shadow-xl overflow-hidden cursor-grab active:cursor-grabbing flex flex-col">
      <Link href={job.page_url} target="_blank">
